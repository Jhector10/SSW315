...
public final class Josephus
{
    ...
    public static int jos1( int people, int passes )
    {
        ...
        for( int i = 1; i <= people; i++ )
            ...
            // Play the game;
        Iterator<Integer> itr = theList.iterator( ); // n people in a circle
        while( people-- != 1 ) // the stop criteria of the whole simulation
        {
            ...
            itr.remove( ); // this represents killing a person   
        }
